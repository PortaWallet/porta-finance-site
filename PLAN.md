...
**Date:** 2026-09-05 · **Soft tip context:** `00043-2qj` · **Path:** `/workspace/porta-finance-site/`
...
| Mini App | https://production-wallet-telegram-omytp43vwa-ew.a.run.app (soft dogfood tip `00043-2qj`; primary entry `@PortaWallet_bot`) |
