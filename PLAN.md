...
**Date:** 2026-09-05 · **Soft tip context:** `00042-n4v` · **Path:** `/workspace/porta-finance-site/`
...
| Mini App | https://production-wallet-telegram-omytp43vwa-ew.a.run.app (soft dogfood tip `00042-n4v`; primary entry `@PortaWallet_bot`) |
