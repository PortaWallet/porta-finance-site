...
export const HERO = {
  ...
  lede: `Create or import, check balances, send, and review swaps in the Telegram Mini App. Account abstraction is the product direction — social recovery, session limits, and gasless are not live. Soft tip dogfood — polish in progress.`,
...
export const TRUST = {
  ...
  body: 'Porta is non-custodial. Every swap is a review — not auto-trade. Soft dogfood: polish in progress, honest claims only. We do not claim MEV-proof, gasless, or live social recovery.',
  panel:
...
export const CONTACT = {
  eyebrow: 'Contact',
  title: 'Talk to Porta',
  body: `Email the team. Porta is an independent AA smart-contract wallet — not a Telegram product. Soft tip ${SOFT_TIP}. We will never ask for your seed phrase.`,
