...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}${POLICY_PATH}`, lastModified: new Date('2026-09-13'), changeFrequency: 'monthly', priority: 0.4 },
    { url: `${SITE_URL}${TERMS_PATH}`, lastModified: new Date('2026-09-13'), changeFrequency: 'monthly', priority: 0.4 },
  ]
}
