...
export const SITE_DESCRIPTION =
  'Porta is an account-abstraction smart-contract wallet. Open it in Telegram to create or import, send, and review swaps. Independent — not a Telegram product.'
