...
describe('soft tip honesty', () => {
  ...
  it('roadmap H2 is What’s next with locked JTBD Coming titles', () => {
    ...
    expect(roadmap).toContain('Subscriptions & Agents')
    expect(roadmap).toContain("statusLabel: 'Coming'")
    expect(roadmap).toContain('Subscriptions and Agents are Coming')
    ...
    expect(roadmap).not.toMatch(/\bDelivered\b/)
    ...
    expect(ui).not.toMatch(/\bDelivered\b/)
  })
  ...
  it('privacy and terms are real EN pages; TOS is /terms not homepage', () => {
