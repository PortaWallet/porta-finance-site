...
describe('APK-AS-TRUTH-PARITY SoT', () => {
  ...
  it('maps Match / Gap / Forbidden without Delivered lies or F6.4 ship claims', () => {
    ...
    expect(parity).toContain('login TG/APK out of scope')
